...
api.post('/agregarHabitacion',md_autenticacion.Auth, habitacionController.agregarHabitaciones);
...
api.get('/habitaciones',md_autenticacion.Auth, habitacionController.verHabitaciones);
module.exports = api;